...
/obj/machinery/computer/mecha/Topic(href, href_list)
	...
	if(href_list["send_message"])
		var/obj/item/mecha_parts/mecha_tracking/MT = mfilte.getObj("send_message")
		...
		return
	if(href_list["shock"])
		var/obj/item/mecha_parts/mecha_tracking/MT = mfilte.getObj("shock")
		MT.shock()
	if(href_list["get_log"])
		var/obj/item/mecha_parts/mecha_tracking/MT = mfilte.getObj("get_log")
